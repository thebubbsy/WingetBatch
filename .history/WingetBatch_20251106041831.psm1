...
function Install-WingetAll {
    ...
    process {
        # If receiving piped package objects, collect them and skip search
        if ($SearchTerm) {
            ...
            # If we collected packages, skip the rest of processing
            if ($pipedPackages.Count -gt 0) {
                return  # Continue collecting, install in end block
            }
        }
