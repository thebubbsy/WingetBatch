...
- **Duplicate Safety**: Automatically removes duplicate package IDs before installation
...
- **Detailed Output**: Structured update data including installed/available versions plus optional unknown-version packages
