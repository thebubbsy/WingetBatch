...
function Get-WingetNewPackages {
    ...
    try {
        ...
        # Calculate how many packages per job
        ...
        if (Get-Module -Name PwshSpectreConsole) {
            ...
            try {
                ...
                if ($selectedChoices.Count -gt 0) {
                    ...
                    # Collect results from ALL jobs (each job returns a hashtable of multiple packages)
                    $allPackageDetails = @{}
                    foreach ($job in $jobs) {
                    ...
                    # Fill in any missing packages with empty data
