...
function Get-WingetNewPackages {
    ...
    try {
        ...
        # Packages are distributed in display order: Job 1 gets top packages, Job 10 gets bottom packages
        ...
        for ($i = 0; $i -lt $actualJobCount; $i++) {
            # Sequential distribution ensures top packages are processed first
