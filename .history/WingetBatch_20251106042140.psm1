...
function Install-WingetPackage {
    ...
    .EXAMPLE
        Install-WingetAll | fob "python 3.13" | Install-WingetPackage
        Filter for Python 3.13, show selection menu, install selected.

    .EXAMPLE
        Install-WingetAll | fob "python", "not", "2.7" | Install-WingetPackage -Silent
        Filter and install without confirmation.
    #>
